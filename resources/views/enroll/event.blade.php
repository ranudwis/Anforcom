...
<body>
    <section id="register" class="mb-5 pb-3">
        <div class="container">
            ...
            <form
                action="{{ route('enroll.event', ['event' => $event->slug]) }}"
                method="post"
                                ...
                                <fieldset>
                                    ...
                                    <div class="row pr-5 pl-5 text-center" id="pilihanPeserta">
                                        <div class="col-6">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="pilihan"
                                                    id="radiobtnIndividu" value="individu">
                                        ...
                                        <div class="col-6">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="pilihan"
                                                    id="radiobtnKelompok" value="kelompok">
                                    ...
                                    <input type="button" name="next" class="btn btn-success next action-button"
                                        value="Selanjutnya" />
                                </fieldset>
                                <fieldset>
                                    <div id="pilihanIndividu">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control validate-input" id="name" type="text"
                                                    data-validate="Type email" value="{{ Auth::user()->name }}" disabled>
                                    ...
                                    <div id="pilihanKelompok">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" id="leader_name" type="text"
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" id="leader_instance" type="text"
                                                    name="university">
                                        ...
                                        <div class="form-group mt-0 pt-0">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control birthdate" id="leader_birthdate" type="date"
                                                    name="leader_birthdate">
                                            </div>
                                            <p id="age"></p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" id="members0name" type="text"
                                                    name="members[0][name]">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" id="members0email" type="text"
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" id="members0contact" type="text"
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" id="members0instance" type="text"
                                                    name="members[0][university]">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" id="members1name" type="text"
                                                    name="members[1][name]">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" id="members1email" type="text"
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" id="members1contact" type="text"
                                                    name="members[1][contact]">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" id="members1instance" type="text"
                                                    name="members[1][university]">
                                        ...
                                        <div class="form-group mt-0 pt-0">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control birthdate" id="members1birthdate" type="date"
                                                    name="members[1][birthdate]">
                                            </div>
                                            <p id="age"></p>
                                        </div>
