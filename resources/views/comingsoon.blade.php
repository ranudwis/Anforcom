...
<html lang="en">
  <head>
    ...
    <!--===============================================================================================-->
    <link rel="apple-touch-icon" sizes="57x57" href="{{ asset('assets/comingsoon/images/icons/apple-icon-57x57.png') }}" />
    <link rel="apple-touch-icon" sizes="60x60" href="{{ asset('assets/comingsoon/images/icons/apple-icon-60x60.png') }}" />
    <link rel="apple-touch-icon" sizes="72x72" href="{{ asset('assets/comingsoon/images/icons/apple-icon-72x72.png') }}" />
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('assets/comingsoon/images/icons/apple-icon-76x76.png') }}" />
    <link
    ...
    {{-- <link rel="manifest" href="{{ asset('assets/comingsoon/manifest.json') }}" /> --}}
    ...
    <div class="flex-col-c-sb size1 overlay1">
      ...
      <div class="w-full flex-w flex-sb-m p-l-80 p-r-80 p-t-22 p-lr-15-sm">
        <div class="wrappic1 mx-auto text-center">
          <a href="#"
            ><img
              src="assets/comingsoon/images/icons/logo2020.png"
              alt="Anforcom 2020"
      ...
      <div class="flex-col-c-m p-l-15 p-r-15 p-t-50 p-b-120">
        ...
        <h2 id="dateDisplay" class="l1-txt1 txt-center p-b-40" style="font-size: 36px; color: white">
        </h3>
      </div>
